...
msbuild SharpOrange\SharpOrange.csproj /p:Configuration=Debug;Platform="Any CPU";AllowUnsafeBlocks=true;SkipBuildPackage=false;RestorePackages=false /p:PreBuildEvent= /p:PostBuildEvent= /p:OutputPath=..\bin\
...
copy bin\SM\SharpOrangeSM.dll build\mono-module\SharpOrangeSM.dll
:END
