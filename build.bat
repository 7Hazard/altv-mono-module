...
mkdir windows
copy mono-module\bin\mono-module.dll windows\mono-module.dll
copy mono-module\mono-2.0-sgen.dll windows\mono-module\bin\mono-2.0-sgen.dll
copy bin\SharpOrange.dll windows\mono-module\SharpOrange.dll
:END